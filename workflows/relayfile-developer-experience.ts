...
Read the current SDK: cat ${RELAYFILE}/sdk/relayfile-sdk/package.json
...
Create ${RELAYFILE}/sdk/relayfile-sdk/tsconfig.json:
- target: ES2022
- module: ESNext
...
cd sdk/relayfile-sdk && npm install 2>&1 | tail -1 && npx tsc --noEmit 2>&1 | tail -3; echo "EXIT: $?"`,
    captureOutput: true,
    failOnError: false,
  })
