...
require_pattern "$OPENAPI_FILE" "/v1/workspaces/{workspaceId}/fs/bulk-read:" "bulk read endpoint"
require_pattern "$OPENAPI_FILE" "operationId: bulkReadFiles" "bulkReadFiles operation"
require_pattern "$OPENAPI_FILE" "BulkReadResponse:" "bulk read response schema"
