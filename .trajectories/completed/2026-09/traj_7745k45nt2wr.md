...
- Focused race tests, full Go, SDK launcher, typecheck/build, contract, release, and secrets checks pass; the only SDK full-suite failure is the existing Node22 ErrorEvent expectation.
