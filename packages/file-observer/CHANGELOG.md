...
All notable changes to `@relayfile/file-observer` are documented here.
...
### Added
- Launchable from the `relayfile` CLI via `relayfile observer`. ([#46])

### Fixed
- Default the observer to the live router path instead of a local stub.
...
[Unreleased]: https://github.com/AgentWorkforce/relayfile/compare/v0.10.65...HEAD
[0.10.65]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.10.65
...
[0.10.48]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.10.48
[0.10.47]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.10.47
[0.10.46]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.10.46
[0.10.45]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.10.45
[0.10.44]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.10.44
...
[0.1.9]: https://github.com/AgentWorkforce/relayfile/releases/tag/v0.1.9
[#40]: https://github.com/AgentWorkforce/relayfile/pull/40
